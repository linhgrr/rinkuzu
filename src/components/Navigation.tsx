      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-12">
          ...
          <div className="hidden md:flex items-center gap-1">
            {session ? (
              <>
                <Link href="/" className="px-4 py-2 text-sm font-medium text-[#1d1d1f] hover:text-[#0071e3] rounded-full transition-colors">
                  Home
                </Link>
                <Link href="/create" className="px-4 py-2 text-sm font-medium text-[#1d1d1f] hover:text-[#0071e3] rounded-full transition-colors">
                  Create
                </Link>
                <Link href="/profile?tab=quizzes" className="px-4 py-2 text-sm font-medium text-[#1d1d1f] hover:text-[#0071e3] rounded-full transition-colors">
                  My Quizzes
                </Link>
                <Link href="/categories" className="px-4 py-2 text-sm font-medium text-[#1d1d1f] hover:text-[#0071e3] rounded-full transition-colors">
                  Categories
                </Link>
                <Link href="/explore" className="px-4 py-2 text-sm font-medium text-[#1d1d1f] hover:text-[#0071e3] rounded-full transition-colors">
                  Explore
                </Link>

                {(session.user as any)?.role === 'admin' && (
                  <Link href="/admin/queue" className="px-4 py-2 text-sm font-medium text-[#af52de] hover:text-[#8944ab] rounded-full transition-colors">
                    Admin
                  </Link>
                )}
