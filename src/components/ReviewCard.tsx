    ...
    return (
        <div className="relative w-full max-w-2xl perspective-1000">
            ...
            >
                ...
                {!isFlipped && (
                    <Card
                        className="absolute inset-0 w-full h-full backface-hidden flex flex-col items-center justify-center p-8 cursor-pointer hover:shadow-lg transition-shadow"
                    ...
                    >
                        <div className="text-center">
                            ...
                            <h3 className="text-2xl font-medium text-[#1d1d1f] mb-8 leading-relaxed">
                                {question.text}
                            </h3>
                ...
                {/* Back Face (Answer) */}
                {isFlipped && (
                    <Card className="absolute inset-0 w-full h-full backface-hidden rotate-y-180 flex flex-col p-8">
                        <div className="flex-1 overflow-y-auto">
                            {/* Question Text Repeated Small */}
                            <p className="text-sm text-[#86868b] mb-6 pb-4 border-b">
                                {question.text}
                            </p>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-start">
                                                <div className={`w-5 h-5 mt-0.5 rounded-full border flex items-center justify-center mr-3 ${isCorrect ? 'bg-green-500 border-green-500 text-white' : 'border-gray-300'
                                                    }`}>
                        ...
                        {/* Rating Buttons */}
                        <div className="mt-8 grid grid-cols-4 gap-3 pt-4 border-t">
                            <button
                                className="flex flex-col items-center p-2 rounded-lg hover:bg-red-50 transition-colors group"
                            ...
                            >
                                ...
                                <span className="text-xs font-medium text-red-600">Again</span>
                            ...
                            >
                                ...
                                <span className="text-[10px] text-gray-400">4d</span>
                            </button>
